        ...
        <div>
          ...
          <ul className="unordered-list-container">
            {tabsList.map(eachTab => (
              <li key={eachTab.tabId} className="list-container">
                <button
                  className="tab-button"
                  type="button"
                  onClick={this.getChangeActiveTabId}
                >
                  <p className="button">{eachTab.displayText}</p>
                </button>
              </li>
            ))}
          </ul>
          <div className="align-images-container">
            <ul className="thumbnail-container">
              {filteredList.map(eachImage => (
                <li key={eachImage.id} className="thumbnail-list-container">
